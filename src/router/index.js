...
export const constantRoutes = [
...

  {
    ...
    children: [{
      ...
      meta: { title: '首页', icon: 'dashboard', affix: true } // 添加固钉：affix: true
    }]
  },
  ...
  // 跳转外网
  {
    ...
    children: [
      {
        path: 'https://yaneylily.github.io/',
        meta: { title: 'Yaney Blog', icon: 'el-icon-link' }
      }
    ]
  },
...
const createRouter = () => new Router({
  // mode: 'history', // require service support 改行代码若取消注释，则URL中出现#号
  scrollBehavior: () => ({ y: 0 }),
